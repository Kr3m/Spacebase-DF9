...
local tMaladyList = {
    ...
    Drugged=
        {
            ...
            sSymptomLog=Log.tTypes.HEALTH_CITIZEN_GETTING_HIGH,
            tReduceMods={
                --Munchies,Increase Energy,Makes people really amused, increase social, and make them want to work more
                Hunger=2.3,
                Energy=-1.5,
                Amusement=-5,
                Duty=5,
                ...
                {
                    {
                        ...
                        sSymptomLog=Log.tTypes.HEALTH_CITIZEN_GETTING_FIREPLAGUE,
                    },
                    {
                        tTimeToSymptoms={60*10,60*15},
                        tReduceMods={
    ...
    -- A rapidly spreading do nothing disease (Except eat, disease can be annoying and sometimes fatal) JAYS disease
    ProcSyn=
        {
