...
local ZONES_BY_BUTTON_ID =
    {
        ...
        --    CommandButton = "COMMAND", -- FIXME: Not implemented yet
    }
...
function m.create()
    ...
    function Ob:init()
        ...
        --        self.rCommandButton = self:getTemplateElement('CommandButton') -- FIXME: Not implemented yet
        ...
        --        self.rCommandButton:addPressedCallback(self.onZoneTypeButtonPressed, self) -- FIXME: Not implemented yet
        ...
        --        self:addHotkey(self:getTemplateElement('CommandHotkey').sText, self.rCommandButton) -- FIXME: Not implemented yet
