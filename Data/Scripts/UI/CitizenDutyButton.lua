    ...
    function Ob:init(rDutyInfo)
        ...
        if rDutyInfo then
            ...
            if rDutyInfo.name then
                ...
                if CharacterConstants.JOB_ICONS[rDutyInfo.enum] == "JanitorIcon_small" then
                    self:setTemplateUITexture('DutyIcon', CharacterConstants.JOB_ICONS[rDutyInfo.enum], 'UI/JanitorIcon')
                else
