...
local tJobTextureInfo =
    {
        ...
        [Character.JANITOR] = Character.JOB_ICONS[Character.JANITOR],
    ...
    function Ob:setJob(eJob)
        if eJob then
            ...
            if sTextureName then
                if sTextureName == "JanitorIcon_small" then
                    self:setTemplateUITexture('JobTexture', sTextureName, 'UI/JanitorIcon')
                else
