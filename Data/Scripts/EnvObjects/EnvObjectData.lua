...
--these are the order the menus are in
EnvObjectData.tMenus=
    {
        ALL={ 'Door','Airlock','HeavyDoor','FirePanel','EmergencyAlarm','HappyBot'},
        ...
        RESIDENCE={},
        GARDEN={'HousePlant','BulbousPlant'},--'StrangePlant'},
...
EnvObjectData.tObjects=
    {
        ...
        SpaceshipEngine=
            {
                ...
                bCanBuildInSpace=true,
				SelectedObjectXoffset = 0,
				SelectedObjectYoffset = 0,
                noRoom=true,
        ...
        Generator=
            {
				...
				SelectedObjectXoffset = 80,
				SelectedObjectYoffset = -10,
                width=2,
                height=2,
                margin=2,
                decayPerSecond=0.03,
        ...
        GeneratorLevel3=
            {
				...
				SelectedObjectXoffset = 140,
				SelectedObjectYoffset = -50,
                width=3,
                height=3,
                margin=2,
                decayPerSecond=0.04,
        ...
        GeneratorLevel4=
            {
				...
				SelectedObjectXoffset = 185,
				SelectedObjectYoffset = -10,
				SelectedObjectScale = 5,
                width=4,
                height=4,
                margin=2,
                decayPerSecond=0.04,
        ...
        OxygenRecyclerLevel3=
            {
				...
				SelectedObjectXoffset = 120,
				SelectedObjectYoffset = -20,
                width = 3,
                height = 3,
                margin = 1,
                decayPerSecond = 0.06,
        ...
        HappyBot=
            {
                spriteName='HappyBot',
                customClass='EnvObjects.HappyBot',
                portrait = 'HappyBot_portrait',
                spriteSheetPath='Environments/HappyBot',
                sPortraitPath = 'Environments/HappyBot',
                friendlyNameLinecode='PROPSX104TEXT',
                description='PROPSX105TEXT',
				SelectedObjectXoffset = -10,
				SelectedObjectYoffset = 0,
                spriteOffsetX=5,
                ...
                nRange=3,
                placeSound = 'placeoxygenfilter',
                researchPrereq = 'HappyBot',
                sidebarIcon = 'icon_airscrubber',
				nPowerDraw = 200,
                tIconOffset = {0, 0},
                sFlavorText = 'OBFLAV039TEXT',
                bCanDeactivate = true,
           },
        AirlockLocker=
            {
     ...
     --[[   StrangePlant=
            {
                 spriteName='strange_plant',
                 sPortraitPath = 'Environments/strange_plant',
                 spriteSheetPath='Environments/strange_plant',
                 friendlyNameLinecode='PROPSX108TEXT',
                 description='PROPSX109TEXT',
                 zoneName='GARDEN',
				 SelectedObjectXoffset = 0,
				 SelectedObjectYoffset = 0,
                 width=1,
                 ...
                 bUsePortraitOffsetHack=true,
                 matterCost=350,
                 portrait = 'strange_plant_icon',
                 placeSound = 'placeplant',
                 researchPrereq = 'PlantLevel2',
                 sidebarIcon = 'icon_plant',
                 -- plants generate small amounts of oxygen
                 -- (amount added to tile every 1/10 of a second)
                 oxygenLevel=10,
        ...
        BulbousPlant=
            {
                spriteName='bulbous_plant',
                sPortraitPath = 'Environments/Bulbous_Plant',
                spriteSheetPath='Environments/Bulbous_Plant',
				spriteOffsetX=-110,
				spriteOffsetXFlipped=-20,
                friendlyNameLinecode='PROPSX106TEXT',
                description='PROPSX107TEXT',
				zoneName='GARDEN',
				changeZone=false,
				SelectedObjectXoffset = 0,
				SelectedObjectYoffset = 0,
        ...
        Jukebox ={
			...
			nPortraitOffY = 0,
			nPortraitScl = 1,
            portrait = 'Juke_Portrait',
            sPortraitPath = 'Environments/Jukebox',
            placeSound = 'placeoxygenfilter',
            --sidebarIcon = 'Juke_Icon',
			sidebarIcon = 'icon_airscrubber',
            nPowerDraw = 25,
            tIconOffset = {0, 0},
