...
local HappyBot = Class.create(EnvObject, MOAIProp.new)

function HappyBot:init(sName, wx, wy, bFlipX, bForce, tSaveData, nTeam)
    EnvObject.init(self,sName, wx, wy, bFlipX, bForce, tSaveData, nTeam)
end

function HappyBot:setLoc(x,y,nLevel)
...
function HappyBot:hover(hoverTime)
