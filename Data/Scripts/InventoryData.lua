...
InventoryData.weaponsImported=false
...
function InventoryData.importWeaponData()
    if InventoryData.weaponsImported==false then
        local i = 1
        for k,v in pairs(WeaponData) do
            --insert doesnt handle string keys. SO you have to do it this way (and no other way)
            InventoryData.tTemplates[k]=v
        end
        InventoryData.weaponsImported=true
    end
end



InventoryData.importWeaponData()
