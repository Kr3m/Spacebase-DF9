...
-- Don't allow most actions within this close of a boundary. This gives
-- us room to path around the edge of bases for construction, mining
-- and the like
World.CHARACTER_SAFETY_TOLERANCE = 2
