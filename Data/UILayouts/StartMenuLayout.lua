...
return 
{
    ...
    tElements =
    {
        ...
        },
		{
            ...
            onHoverOn =
            {
                { key = 'ButtonLoadBaseText', color = Gui.BRIGHT_AMBER, },
                { playSfx = 'hilight', },
            },
            onHoverOff =
            {
                { key = 'ButtonLoadBaseText', color = Gui.AMBER, },
            },
        },
		{
            key = 'ButtonSaveBase',
            ...
            onHoverOn =
            {
                { key = 'ButtonSaveBaseText', color = Gui.BRIGHT_AMBER, },
                { playSfx = 'hilight', },
            },
            onHoverOff =
            {
                { key = 'ButtonSaveBaseText', color = Gui.AMBER, },
            },
        },
        {
            key = 'ButtonSettings',
