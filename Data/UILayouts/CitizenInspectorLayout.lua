        ...
        tElements =
            {
                ...
                -- Tabbed Pane
                {
                    ...
                    type = 'tabbedPane',
                    pos = { 0, -428 },
                    -- FIXME: height of the tabbed pane is bumped to 755 from 655
                    --   but should really be calculated based off the current Viewport dimensions
                    rect = { 0, 0, nButtonWidth-20, 755},
                },
            },
    }
